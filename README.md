...
| ORM | GORM v1 | 功能完善的 ORM 库 |
| SQLite 驱动 | mattn/go-sqlite3 | 成熟稳定，支持自增主键 |
...
- 构建阶段：`golang:1.25`，支持 CGO 编译
- 运行阶段：`debian:bookworm-slim`，兼容性好，支持 CGO 运行时依赖
- SQLite 驱动：`mattn/go-sqlite3`，成熟稳定，支持自增主键
